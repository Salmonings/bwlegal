...
async function action(_prev: ActionState, formData: FormData): Promise<ActionState> {
  return saveEmployeeDocumentAction(formData);
}

export function EmployeeDocumentRow(props: Props) {
  ...
  return (
    ...
    >
      ...
      <input type="hidden" name="employeeDocumentTypeId" value={props.employeeDocumentTypeId} />
